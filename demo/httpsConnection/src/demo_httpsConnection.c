...
#define SERVER_IP           "app-argus-server.herokuapp.com" // Replace this with the host to connect
#define SERVER_PORT         80     // Replace this with the port to connect
#define SSL_SERVER_PORT     "80"   // Replace this with the port to connect
#define SERVER_PATH         "/ping" // [GET] Replace this with your path
#define SERVER_PATH_POST    "/module/save-location/" // [POST] Replace this with your path
#define SERVER_DATA         "1/2/3" // [POST] Replace this with POST data
/*******************************************************************/
        ...
        case API_EVENT_ID_NETWORK_REGISTERED_ROAMING:
        {
            ...
            else
            {
                Network_PDP_Context_t context = {
                    .apn        ="datos.personal.com", // Replace this with your APN name
                    .userName   = "datos"    ,
                    .userPasswd = "datos"
                };
